									...
									<form action="">
										<table id="customers">
											...
											<tr>
												...
												<td><input type="text" name="projectDesc" required></td>
											</tr>
											<tr>
												<th>Project Time Required:</th>
												<td><input type="text" name="projectTimeRequired" placeholder="Enter in terms of days"
													required /></td>
											</tr>
											<tr>
												<th></th>
