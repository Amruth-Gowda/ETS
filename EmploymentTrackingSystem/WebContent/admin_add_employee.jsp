			...
			<ul class="rslides" id="slider">
				<li>
					<div class="w3layouts-banner-top">
						...
						<div class="container">
							<div
								style="margin: 3cm 9cm; color: white; font-style: Sans-serif; font-size: 18px">
								...
								%>
								<jsp:setProperty name="staffobj" property="*" />
								<%
									if (staffobj.createStaff() == 1) {
								%>
								<script type="text/javascript">
									alert("Staff Creation Successfull!!!");
									window.location.href = "admin_add_employee.jsp";
								</script>
								<%
									} else {
								%>
