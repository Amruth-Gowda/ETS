	...
	<div class="header">
		...
		<div class="collapse navbar-collapse"
			...
			<ul class="nav navbar-nav navbar-right">
				...
				<li><a href="manager_view_team_members.jsp">View Team
						Members</a></li>
				...
				<li>
					<div class="w3layouts-banner-top">
						<div class="banner-dott">
							<div class="container">
								<div
									style="margin: 1cm 5cm; color: white; font-style: Sans-serif; font-size: 18px">
									Project List!!!
									<table id="customers">
										<tr>
											<th>Project Id</th>
										...
										<jsp:useBean id="projectobject" class="com.model.Project"></jsp:useBean>
										<%
											ResultSet result = projectobject.viewProjects();
										%>
										<%
											while (result.next()) {
										%>
										<tr>
											<th><%=result.getString("project_id")%></th>
											<th><%=result.getString("project_name")%></th>
											<th><%=result.getString("project_desc")%></th>
											<th><%=result.getString("project_time_required")%></th>
											<th><%=result.getString("project_status")%></th>
										</tr>
										<%
											}
										%>
