	...
	<div class="header">
		...
		<div class="collapse navbar-collapse"
			...
			<ul class="nav navbar-nav navbar-right">
				...
				<li><a href="manager_project_performance.jsp">Project Performance</a></li>
				<li><a href="manager_teamlead_performance.jsp">Average Performance</a></li>
				...
				<li>
					<div class="w3layouts-banner-top">
						<div class="banner-dott">
							<div class="container">
								<div
									style="margin: 1cm 7cm; color: white; font-style: Sans-serif; font-size: 18px">
									Team Members Average Performance!!
									<%
									Performance performance = new Performance();
									ResultSet res = performance.showMemberPerformance();
								%>
									<table id="customers">
										<tr>
											<th>Id</th>
										...
										<tr>
											...
											<td><%=String.format("%.2f",res.getDouble("avg")) %></td>
										</tr>
										<%
											}
										%>
