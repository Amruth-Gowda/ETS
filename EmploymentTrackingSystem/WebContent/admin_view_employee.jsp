				...
				<li>
					<div class="w3layouts-banner-top">
						<div class="banner-dott">
							<div class="container">
								<div
									style="margin: 1cm 0cm; color: white; font-style: Sans-serif; font-size: 18px">
									...
									<table id="customers">
										...
										<jsp:useBean id="getstaffdetails" class="com.model.Staff"></jsp:useBean>
										<%
											ResultSet result = getstaffdetails.getStaffDetails();
										%>
										<%
											while (result.next()) {
										%>
