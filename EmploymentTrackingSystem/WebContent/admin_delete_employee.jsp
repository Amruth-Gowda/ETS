	...
	<div class="header">
		...
		<div class="collapse navbar-collapse"
			...
			<ul class="nav navbar-nav navbar-right">
				...
				<li><a href="admin_add_employee.jsp">Add Employee</a></li>
				<li><a href="admin_edit_employee.jsp">Edit Employee</a></li>
				<li><a href="admin_view_employee.jsp">View Employee</a></li>
				<li><a href="admin_delete_employee.jsp">delete Employee</a></li>
						...
						<div class="banner-dott">
							<div class="container">
								<div
									...
									%>
									<jsp:setProperty property="*" name="staffobj" />
									<form action="">
										<table class="table-properties" border=1>
											<%
												int id = Integer.parseInt(request.getParameter("id"));
														ResultSet result = staffobj.getStaffDetailsById(id);
														if (result != null) {
															if (result.next()) {
											%>
											<tr>
												...
												<td><input type="text" name="id"
													value="<%=result.getInt("staff_id")%>" readonly /></td>
											</tr>
											<tr>
												<th>Name</th>
												<td><input type="text" name="name"
													value="<%=result.getString("staff_name")%>" readonly/></td>
											</tr>
											<tr>
												<th>Gender</th>
												<td><input type="text" name="gender"
													value="<%=result.getString("staff_gender")%>" readonly/></td>
											</tr>
											<tr>

												<th>Date Of Birth</th>
												<td><input type="text" name="dob"
													value="<%=result.getString("staff_dob")%>" readonly/></td>
											</tr>
											<tr>

												<th>Email</th>
												<td><input type="text" name="email"
													value="<%=result.getString("staff_email")%>" readonly/></td>
											</tr>
											<tr>

												<th>Password</th>
												<td><input type="text" name="password"
													value="<%=result.getString("staff_password")%>" readonly/></td>
											</tr>
											<tr>

												<th>Mobile Number</th>
												<td><input type="text" name="mobileNumber"
													value="<%=result.getString("staff_mobile_number")%>" readonly/></td>
											</tr>
											<tr>

												<th>Address</th>
												<td><input type="text" name="address"
													value="<%=result.getString("staff_address")%>" readonly/></td>
											</tr>
											<tr>
												<th>Designation</th>
												<td><input type="text" name="designation"
													value="<%=result.getString("staff_designation")%>" readonly/></td>
											</tr>
											<tr>
												<td></td>
												<td><input type="submit" name="deleteEmployee"
									...
									<script type="text/javascript">
										alert("Invalid Id!!!!");
										window.location.href = "admin_edit_employee.jsp";
									</script>
									...
									<jsp:setProperty property="*" name="staffobj" />
									<%
										int result = staffobj.deleteStaff();
											if (result == 1) {
									%>
									...
									%>
									<script type="text/javascript">
										alert("OOOoooopssss delete Failed!!!!");
									</script>
									<%
										}
										}
