				...
				<li>
					<div class="w3layouts-banner-top">
						<div class="banner-dott">
							<div class="container">
								<div
									style="margin: 1cm 4cm; color: white; font-style: Sans-serif; font-size: 18px">
									Modules List!
									<table id="customers">
										<tr>
											<th>Module Id</th>
										...
										<jsp:useBean id="moduleobject" class="com.model.Module"></jsp:useBean>
										<%
											String emailId = session.getAttribute("entered_email").toString();
											System.out.println(emailId);
											ResultSet result = moduleobject.teamLeadModuleView(emailId);
										%>
										<%
											while (result.next()) {
										%>
										<tr>
											<th><%=result.getInt("module_id")%></th>
											<th><%=result.getInt("project_id")%></th>
											<th><%=result.getString("module_name")%></th>
											<th><%=result.getString("module_desc")%></th>
											<th><%=result.getString("module_time_required")%></th>
											<th><%=result.getString("module_status")%></th>
										</tr>
										<%
											}
										%>
