				...
				<li>
					<div class="w3layouts-banner-top">
						<div class="banner-dott">
							<div class="container">
								<div
									style="margin: 1cm 9cm; font-style: Sans-serif; font-size: 18px">
									Assign Project!!!!
									<jsp:useBean id="projectAssignObj"
										class="com.model.ProjectAssignment" />
									<form action="">
										<table id="customers">
											<tr>
												<th>Project Id:</th>
												<td><select name="projectId" required>
														<option value="">None</option>
														<jsp:useBean id="projectobj" class="com.model.Project" />
														<%
															ResultSet result = projectobj.viewProjects();
															while (result.next()) {
														%>
											...
											<tr>
												<th>Team Lead Id:</th>
												<td><select name="teamLeadId" required>
														<jsp:useBean id="staffobj" class="com.model.Staff" />
														<option value="">None</option>
														<%
															ResultSet res = staffobj.getStaffDetailsByDesignation("teamlead");
															while (res.next()) {
														%>
														<option value="<%=res.getInt("staff_id")%>"> <%=res.getInt("staff_id")%></option>
														<%
															}
														%>
												</select></td>
									...
									%>
									<jsp:setProperty property="*" name="projectAssignObj" />
									<%
									int resProject = projectAssignObj.assignProject();
										if ( resProject == 1) {
									%>
									<script type="text/javascript">
										alert("Assigning Project Successfull!!!");
										window.href.location = "manager_add_project.jsp";
									</script>
									<%
										}
									else if (resProject == -1) {
									%>
									<script type="text/javascript">
									...
									%>
									<script type="text/javascript">
										alert("Assigning Project Failed!!");
									</script>
									<%
										}
										}
