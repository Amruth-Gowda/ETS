						...
						<div class="banner-dott">
							<div class="container">
								<div
										...
										<table class="table-properties" border=1>
											...
											<tr>
												...
												<td><input type="text" name="name"
													value="<%=result.getString("staff_name")%>" /></td>
											</tr>
											<tr>
												<th>Gender</th>
												<td><input type="text" name="gender"
													value="<%=result.getString("staff_gender")%>" /></td>
											</tr>
											<tr>

												<th>Date Of Birth</th>
												<td><input type="text" name="dob"
													value="<%=result.getString("staff_dob")%>" /></td>
											</tr>
											<tr>

												<th>Email</th>
												<td><input type="text" name="email"
													value="<%=result.getString("staff_email")%>" /></td>
											</tr>
											<tr>

												<th>Password</th>
												<td><input type="text" name="password"
													value="<%=result.getString("staff_password")%>" /></td>
											</tr>
											<tr>

												<th>Mobile Number</th>
												<td><input type="text" name="mobileNumber"
													value="<%=result.getString("staff_mobile_number")%>" /></td>
											</tr>
											<tr>

												<th>Address</th>
												<td><input type="text" name="address"
													value="<%=result.getString("staff_address")%>" /></td>
											</tr>
											<tr>
												<th>Designation</th>
												<td><input type="text" name="designation"
													value="<%=result.getString("staff_designation")%>" /></td>
											</tr>
											<tr>
												<td></td>
									...
									<jsp:setProperty property="*" name="staffobj" />
									<%
										int result = staffobj.updateStaff();
											if (result == 1) {
									%>
