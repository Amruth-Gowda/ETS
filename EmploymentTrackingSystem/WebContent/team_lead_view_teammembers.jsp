				...
				<div class="w3layouts-banner-top">
					...
					<div class="container">
								<div
									...
									<%
										String desigantion = "teammember";
										ResultSet result = staffobj.getStaffDetailsByDesignation(desigantion);
									%>
									<table id="customers">
										...
										%>
										<tr>
											<th><%=result.getString("staff_id")%></th>
											<th><%=result.getString("staff_name")%></th>
											<th><%=result.getString("staff_email")%></th>
											<th><%=result.getString("staff_mobile_number")%></th>
										</tr>
										<%
											}
										%>
