						...
						<div class="banner-dott">
							<div class="container">
								<div
									...
									<form action="">
										<table id="customers">
											<tr>
												...
												<td><select name="projectId">
														...
														<%
															...
															ResultSet result = projectobj.viewAssignedProjects(emailId);
															while (result.next()) {
														%>
														<option value="<%=result.getInt("project_id")%>"><%=result.getInt("project_id")%></option>
														<%
															}
														%>
												</select></td>
											...
											<tr>
												...
												<td><input type="text" name="moduleDesc" required></td>
											</tr>
											<tr>
												<th>Module Time Required:</th>
												<td><input type="text" name="moduleTimeRequired" placeholder="Enter in terms of days"
													required /></td>
											</tr>
											<tr>
												<th></th>
									...
									<%
										if (moduleobj.createModule() == 1) {
									%>
									<script type="text/javascript">
										alert("Module Creation Successfull!!!");
										window.href.location = "team_lead_add_module.jsp";
									</script>
									<%
										} else {
									%>
